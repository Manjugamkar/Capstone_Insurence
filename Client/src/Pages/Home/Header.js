...
const Header = () => {
  ...
  return (
    <div>
      ...
      <h1 className="marquee-text title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-800">
        Welcome to Lead Management System
      </h1>
    </div>
            {/* <h6 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-200">
