      ...
      <div className="container px-5 mt-10 mb-20 mx-auto">
        <div className="flex flex-wrap -mx-4 -mb-10 text-center">
          ...
          <div className="sm:w-1/2 mb-10 px-4">
            ...
            <button className="inline-flex items-center justify-center px-4 py-2 text-md font-medium text-white bg-orange-500 rounded-md hover:bg-orange-600 focus:ring-orange-300 focus:outline-none focus:ring h-10 w-32 mt-7" onClick={handleRedirect} >
              Get Insured
            </button>
